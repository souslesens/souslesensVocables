...
//select source Data
    ...
    createTriples: function (sourceData,graphUri,targetSparqlServerUrl, options, callback) {
        ...
        async.eachSeries(slices, function (sourcePredicates, callbackEach) {
            var predicates = "";
                ...
                if (!conceptUri) {
                    ...
                    if (!keepOriginalUris) {
                        ...
                        if (addExactMatchPredicate)
                            predicates += conceptUri + " skos:exactMatch <" + item.concept.value + "> ."
                    ...
                    if (broader && item['broader' + i + 'Label'].value) {
                        ...
                        if (!broaderUri) {
                            if (!keepOriginalUris) {
                                ...
                                if (addExactMatchPredicate)
                                    predicates += broaderUri + " skos:exactMatch <" + item.concept.value + "> ."
                            } else {
