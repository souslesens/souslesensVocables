...
const argv = yargs.alias("dck", "docker_file").describe("dck", "path to docker-compose.yaml").alias("cfg", "config_dir").describe("cfg", "path to config directory").demandOption(["dck", "cfg"]).help().argv
