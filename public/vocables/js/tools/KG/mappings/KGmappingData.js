var KGmappingData = (function () {
    ...
    self.loadKG_SQLModel = function (dbName) {
        ...
        if (!dbName)
            dbName = $("#KGmappings_DatabaseSelect").val();
    ...
    self.showAddFilteredViewDialog = function () {
        ...
        var html = "<div style='display: flex;flex-direction: column'> view suffix (added to table name)<input size='20' id='KGmapping_viewSuffix'><br>" +
        ...
        function displaySampleData(data) {
            ...
            setTimeout(function () {
                ...
                $(".dataSample_type").bind("dblclick", function (event) {
                    ...
                    "<span class=\"popupMenuItem\" onclick=\"KGadvancedMappingtoolPanelLabel();\"> find best matches</span>"
    ...
    self.menuActions = {
        ...
        validateConditionalTypeMappings: function () {
            ...
            var types = []
            $("#KGadvancedMapping_manualMappingContainerDiv").children().each(function () {
