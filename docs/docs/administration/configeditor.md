...
- **Shared users data**: When enabled, users sharing this profile can see each other in the users list. When disabled, sharing this profile does not expose users to one another.
...
- **Shared users data**: When enabled, users sharing this profile see each other in the users list (e.g. to share user data and assign annotation templates). Admins always see every user.
