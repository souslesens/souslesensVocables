...
export default [
    {
        ignores: ["mainapp/static", "mainapp/lib", "public/YasGui", "public/vocables/js/external", "docker-data"],
    },
    ...
    {
        files: ["**/app.js", "scripts/*.js", "other/**/*.js", "bin/**/*.js", "api/**/*.js", "**/webpack.config.js", "**/.eslintrc.js", "model/**/*.js", "mainapp/*.js"],
        languageOptions: {
            globals: {
                ...globals.node,
            },
