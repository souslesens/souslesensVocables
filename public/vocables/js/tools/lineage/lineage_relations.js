    ...
    async.series(
      [
        ...
        function(callbackSeries) {
          ...
          if (relations.length > self.maxRelationToDraw && output == "visjs") return callbackSeries("Cannot draw : too many relations " + relations.length + " max " + self.maxRelationToDraw);
