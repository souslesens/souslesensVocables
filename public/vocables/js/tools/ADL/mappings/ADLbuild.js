var ADLbuild = (function () {
    ...
    self.buildTriples = function () {
        ...
        self.checked_tables.forEach(function (table) {
            mappingFileNames.push(ADLmappings.currentKGsource + "_" + ADLmappingData.currentDatabase + "_" + table.replace(/_/, "."))
        })
        ...
        var skipOneModelOrphans = $("#ADLbuild_skipOneModelOrphans").prop("checked")
        var skipLocalDictionaryOrphans = $("#ADLbuild_skipLocalDictionaryOrphans").prop("checked")
