    ...
    showAddEdgeFromGraphDialog: function(edgeData, callback) {
      ...
      $("#LineagePopup").load("snippets/lineage/lineageAddEdgeDialog.html", function() {
        ...
        if (!Config.sources[Lineage_sources.activeSource].editable) {
          $("#lineageAddEdgeDialog_Title").html("source " + Lineage_classes.mainSource + " is not editable");
          return;
        } else {
          $("#lineageAddEdgeDialog_Title").html("upper ontology : <b>" + Config.currentTopLevelOntology + "</b><br>" +
            self.sourceNode.label + " -> " + self.targetNode.label);
        }
          ...
          [
            ...
            function(callbackSeries) {
              Lineage_upperOntologies.getUpperOntologyObjectPropertiesDescription(Config.currentTopLevelOntology, false, function(err, result) {
                ...
                Lineage_upperOntologies.objectPropertiesMap = result;
                callbackSeries();
            ...
            function(callbackSeries) {
              Lineage_upperOntologies.getAuthorizedProperties(Config.currentTopLevelOntology,
