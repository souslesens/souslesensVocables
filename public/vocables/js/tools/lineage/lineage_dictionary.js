      ...
      [
        ...
        function(callbackSeries) {
          ...
          for (var key in Config.dictionaryMetaDataPropertiesMap) {
            if (self.dataTablesOrderedColumns.indexOf(key) < 0) if (self.dataTablesHiddenColumns.indexOf(key) < 0) cols.push({
              title: key,
              defaultContent: ""
            });
          }
...
"searchable": false
  ...
  self.validation = {
    ...
    remove: function(data) {
      ...
      async.eachSeries(restrictions, function(restrictionNode, callbackEach) {
