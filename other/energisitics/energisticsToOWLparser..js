        ...
        parser.parseString(data, function (err, result) {
            ...
            if (complexTypes) {
                complexTypes.forEach(function (item) {
                    ...
                    } else if (item["xs:sequence"])
                        sequences = [item["xs:sequence"]][0]
                ...
                items.forEach(function (aClass, index) {
                    ...
                    if (aClass.elements) {
                        aClass.elements.forEach(function (element) {
                            if (element.name == "GeochronologicalUnit")
                                var x = 3
...
if(typeArray[1].endsWith("Ext")){
    typeArray[1]=typeArray[1].replace("Ext","")
                            ...
                            var elementUri
                            if (typeArray[0] == "xs")
                                elementUri = "http://www.w3.org/2001/XMLSchema" + typeArray[1];
                            else if (typeArray[0] != prefix)
                                elementUri = graphUri.replace(prefix, typeArray[0]) + typeArray[1]
                            else
                                elementUri = graphUri + typeArray[1]
                    ...
                    if (aClass.name == "MatrixCementKind")
                        var x = 3
