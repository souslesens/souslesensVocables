...
var ADLbrowserCustom=(function(){
    ...
    var self= {}
        ...
        if(ADLbrowserGraph.currentGraphNode.data.type=="http://w3id.org/readi/rdl/D101001053"){
            var html=  "    <span   onclick=\"ADLbrowserCustom.showREADIrestrictionsOnGraph();\">show READI restrictions </span>"
...
var source="CFIHOS_READI"
        Sparql_OWL.getObjectRestrictions(source,id,{},function(err, result){
            ...
            visjsData.nodes.push({
                id: source+"_"+ADLbrowserGraph.currentGraphNode.data.id,
                label: source+" "+ADLbrowserGraph.currentGraphNode.data.label,
                shape: "square",
