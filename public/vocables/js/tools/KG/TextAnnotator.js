var TextAnnotator=(function(){
    ...
    self.setAnnotation=function(ontologyNode){
        ...
        var color;
        if(ontologyNode.jstreeDiv=="KGmappings_OneModelTree")
            color="lightgreen"

        else if(ontologyNode.jstreeDiv=="KGmappingsjsOtherOntologiesTreeDiv")
            color="lightblue"
        else if(ontologyNode.jstreeDiv=="KGmappingPropertiesTree")
            color="orange"
