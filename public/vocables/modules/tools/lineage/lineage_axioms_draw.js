...
var Lineage_axioms_draw = (function() {
  ...
  self.getNodeAxioms = function(sourceLabel, nodeId, depth, options, callback) {
    ...
    var axiomPredicates = "<http://www.w3.org/2002/07/owl#complementOf>|" +
      "<http://www.w3.org/2002/07/owl#disjointWith>|" +
      "<http://www.w3.org/2002/07/owl#disjointUnionOf>|" +
      "<http://www.w3.org/2002/07/owl#hasKey>|" +
      "<http://www.w3.org/2002/07/owl#equivalentClass>|" +
    ...
    axiomPredicates += "|<http://www.w3.org/2002/07/owl#Restriction>|" +
      "<http://www.w3.org/2002/07/owl#onProperty>|" +
      "<http://www.w3.org/2002/07/owl#someValuesFrom>|" +
      "<http://www.w3.org/2002/07/owl#allValuesFrom>|" +
      "<http://www.w3.org/2002/07/owl#hasValue>|" +
    ...
    var query = "PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>PREFIX owl: <http://www.w3.org/2002/07/owl#>PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> \n" +
      ...
      " ?sIsBlank ?oIsBlank" +
      " " + fromStr +
      "          WHERE {?s (" + axiomPredicates + "){1,1} ?o0. \n" +
      "          ?s ?p ?o." +
      "  optional{ ?s rdf:type ?sType.}\n" +
      "  optional{    ?o rdf:type ?oType.}\n" +
      "  optional{   ?s rdfs:label ?sLabel.}\n" +
      ...
      " \n" +
      "  filter ( ?p in (" + axiomPredicates.replace(/\|/g, ",") + "))\n" +
      "        {  SELECT distinct  ?s ?p0 ?o0    \n" +
      "          WHERE {?s (" + axiomPredicates + ") ?o0. \n" +
      "               \n" +
      "  }}\n" +
      "}\n" +
      "            limit 10000";
