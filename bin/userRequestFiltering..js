  ...
  checkQueryByRegex: function(query, userGraphUrisMap, callback) {
    ...
    if (!operation) {
      ...
      if (!graphUri) {
        ...
        // temporary solution for stored queries !!!!!
        if (graphUri.indexOf("http://souslesens.org/resource/stored-") == 0) {

        }


        else if (!userGraphUrisMap[graphUri]) {
...
// temporary solution for stored queries !!!!!
      ...
      //check grap huris authorized for user
      var fromError = "";
