        ...
        async.series(
          [
            ...
            function(callbackSeries) {
              ...
              async.eachSeries(csvData, function(lines, callbackEachLines) {
                          ...
                          //get value for Subject
                          {
                            ...
                            if (item.lookup_s) {
                              if (!lookUpMap[item.lookup_s])
                                return callbackSeries2("no lookup named " + item.lookup_s);
                          ...
                          //get value for Object
                          {
                            ...
                            if (item.lookup_o) {
                              if (!lookUpMap[item.lookup_o])
                                return callbackSeries2("no lookup named " + item.lookup_o);
