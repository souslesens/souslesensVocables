  ...
  self.showTriples = function() {
    ...
    function triplesToHtml(triples, divId) {
      ...
      triples.forEach(function(triple, index) {
        html += "<div class='axioms_create_triple'>" + getLabel(triple.subject) + "<span class='axioms_create_triplePredicate'>" + getLabel(triple.predicate) + "</span>" + getLabel(triple.object) + "</div>";
      });
