...
var gaiaToSkos = {
    ...
    parseTxt: function () {
        ...
        for (var key in categoriesClassMap) {
            ...
            if (!object)
                object = "<http://data.total.com/resource/dictionary/gaia/" + "null" + ">";
            else
    ...
    , writeAcronymsTriples: function () {
        ...
        objs.forEach(function (item, index) {
            ...
            if (item.term) {
                ...
                if(syn)
                str += subject + " <http://www.w3.org/2004/02/skos/core#altLabel> '" + syn + "'@en .\n";
                if(acronymEn)
                str += subject + " <http://www.w3.org/2004/02/skos/core#altLabel> '" + acronymEn + "'@en .\n";
                if(synEn)
                str += subject + " <http://www.w3.org/2004/02/skos/core#altLabel> '" + synEn + "'@en .\n";
