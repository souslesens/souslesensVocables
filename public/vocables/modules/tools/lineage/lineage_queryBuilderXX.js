...
var Lineage_queryBuilder = (function() {
  ...
  self.test = function() {
    ...
    self.listVocabsFn=listVocabsFn

    function listQueryTypeFn() {
      var choices = [
    ...
    self.listQueryTypeFn=listQueryTypeFn
    ...
    var nextStep = function(obj, previousResult) {
      ...
      if (typeof key == "function") {
       ...
       var value=obj[key]
        ...
        nextStep( value,fnResult)
      }else if (typeof value == "object") {
        if (value[fnResult]){
          nextStep( value[fnResult],null)
        }else{
 ...
 // doNext(query);
    ...
    nextStep (workflow, listVocabsFn, null)
  };
