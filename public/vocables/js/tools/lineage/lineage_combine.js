var Lineage_combine = (function() {
    ...
    self.mergeNodes = function(testObj) {
      ...
      var jstreeNodes;
      if ($("#LineageMerge_nodesJsTreeDiv").jstree(true))
        jstreeNodes = $("#LineageMerge_nodesJsTreeDiv").jstree(true).get_checked(true);
      ...
      async.eachSeries(sources, function(source, callbackEachSource) {
        ...
        if (!targetGraphUri || !editable)
          return alert("targetSource must have  graphUri and must be editable");
    ...
    self.testMerge = function() {
      ...
      var jstreeNodes = [
          ...
          },*/
        {
          ...
          "children": [
            "http://data.total.com/resource/tsf/ontology/gaia-test/de62adbf1d"
          ],
          "children_d": [
            "http://data.total.com/resource/tsf/ontology/gaia-test/de62adbf1d"
          ],
