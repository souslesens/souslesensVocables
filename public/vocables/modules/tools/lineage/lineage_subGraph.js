        ...
        self.getSubGraphResources(sourceLabel, classUri, function (err, result) {
           ...
           // return;
                ...
                result.forEach(function(item){
                    if(!  itemsMap[item.s.value])
                    itemsMap[item.s.value]={}
                    ...
                    itemsMap[item.s.value].label=item.o.value
                    if(item.p.value.endsWith("onProperty"))
                        itemsMap[item.s.value].property=item.o.value
                    if(item.p.value.endsWith("onClass"))
                        itemsMap[item.s.value].range=item.o.value
