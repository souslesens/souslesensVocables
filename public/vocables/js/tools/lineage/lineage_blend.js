      ...
      $("#LineagePopup").load("snippets/lineage/lineageAddEdgeDialog.html", function() {
        ...
        let options = {
          ...
          selectTreeNodeFn: function(event, obj) {
            ...
            var inSource;
            var options={}
            if (obj.node.data.id == "http://www.w3.org/2002/07/owl#sameAs")// le sameAs sont tous dans le dictionaire
              inSource = Config.dictionarySource;
            else {//soit  dans predicateSource
          ...
          [
            function(callbackSeries) {
              ...
              jstreedata2.push({
                ...
                parent: "#",
                data: {
                  id: "http://www.w3.org/2002/07/owl#sameAs", inSource: Config.dictionarySource
                }
              });
              ...
              jstreedata2.push({
                ...
                parent: "#",
                data: {
                  id: "http://www.w3.org/1999/02/22-rdf-syntax-ns#type", inSource: Lineage_classes.mainSource
                }
              });
              if(Config.sources[Lineage_classes.mainSource].schemaType=="OWL") {
                jstreedata2.push({
                  ...
                  parent: "#",
                  data: {
                    id:  "http://www.w3.org/2000/01/rdf-schema#subClassOf", inSource: Lineage_classes.mainSource
                  }
                });
              }
              // var data = ["owl:sameAs"]
