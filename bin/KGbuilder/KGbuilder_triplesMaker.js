...
//get value for Subject
    ...
    loadLookups: function(tableMappings, callback) {
      var lookUpsMap = {};
      async.eachSeries(tableMappings.lookups, function(lookup, callbackEachLookup) {
    ...
    loadData: function(tableMappings, options, callback) {
      ...
      if (tableMappings.csvDataFilePath) {
        ...
        KGcreator_mappings.message(options.clientSocketId, "loading data from csv file", false);
        ...
        KGbuilder_socket.message(options.clientSocketId, "loading data from sql server", false);
