...
var OntologyModels = (function () {
   ...
   validProperties = common.array.union(validProperties, noConstaintsArray);*/
    ...
    self.getInferredModel = function (source, options, callback) {
        if (!Config.ontologiesVocabularyModels[source]) Config.ontologiesVocabularyModels[source];
        if (false && Config.ontologiesVocabularyModels[source].inferredClassModel) return callback(null, Config.ontologiesVocabularyModels[source].inferredClassModel);
        else {
