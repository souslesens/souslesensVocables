var Lineage_selection = (function () {
    ...
    self.listNodesSelection = function (allGraphNodes) {
        if (allGraphNodes) Lineage_selection.selectedNodes = Lineage_whiteboard.lineageVisjsGraph.data.nodes.get();

        if (Lineage_selection.selectedNodes.length == 0) Lineage_selection.selectedNodes = Lineage_whiteboard.lineageVisjsGraph.data.nodes.get();
