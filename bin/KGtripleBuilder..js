                        ...
                        async.eachSeries(
                          ...
                          function(line, callbackEachLines2) {
                            ...
                            mapping.tripleModels.forEach(function(item) {
                              ...
                              if (!line[item.s] && !item.subjectIsSpecificUri && item.s.indexOf("$_")!=0) {// virtual column or specific url
                                return;
                              }
                              ...
                              //get value for Subject
                              {
                                ...
                                else if (item.s.indexOf("$_")==0) {// virtual column
                                  if (item.o.indexOf("$_")!=0 && allColumns[item.o] && !line[item.o]) {  // ne pas creer des triplest sans objet
                              ...
                              //get value for Object
                              {
                                ...
                                else if (item.o.indexOf("$_")==0) {// virtual column
                                  var blankNode = blankNodesMap[item.o];
                                  if (!blankNode) {
                                    blankNode = getNewBlankNodeId();
                                    blankNodesMap[item.o] = blankNode;
...
propertyStr = line[item.p];
  ...
  deleteMappingFileTriples: function(mappings, sparqlServerUrl, callback) {
    var query = "";
    query += "with  GRAPH <" + mappings.graphUri + "> " +
      "delete {?s ?p ?o} where {?s ?p ?o. ?s <" + KGtripleBuilder.mappingFilePredicate + "> '" + mappings.fileName + "'}";
