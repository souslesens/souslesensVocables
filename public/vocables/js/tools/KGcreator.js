...
var KGcreator = (function () {
    ...
    self.usualObjectClasses = ["owl:Class", "owl:Property", "owl:NamedIndividual", "skos:Concept", "skos:Collection", "slsv:TopConcept", "_function", ""];
    self.usualSubjectTypes = ["_function", ""];
