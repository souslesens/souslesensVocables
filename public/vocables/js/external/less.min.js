...
!(function (e, t) {
    ...
    var i = function (t, i, n) {
            ...
            l.setAttribute("type", "text/css"),
                ...
                (l.id = s),
                l.styleSheet || (l.appendChild(t.createTextNode(i)), (a = null !== o && o.childNodes.length > 0 && l.childNodes.length > 0 && o.firstChild.nodeValue === l.firstChild.nodeValue));
    ...
    m.prototype = Object.assign(new u(), {
        ...
        toCSS: function (e) {
            ...
            var t = this.value,
                i = e.firstSelector;
            return (
                t instanceof p && (e.firstSelector = !0), (t = t.toCSS ? t.toCSS(e) : t), (e.firstSelector = i), "" === t && "&" === this.combinator.value.charAt(0) ? "" : this.combinator.toCSS(e) + t
            );
        },
    });
    ...
    function I(e, t) {
        return (
            ...
            S(e)
                ...
                : "Object" !== x((i = e)) || i.constructor !== Object || Object.getPrototypeOf(i) !== Object.prototype
                ? e
                : (function () {
                      ...
                      return (
                          (S(t.props) && !t.props.includes(n)) ||
                              (function (e, t, i, n, r) {
                                  ...
                                  "enumerable" === s && (e[t] = i), r && "nonenumerable" === s && Object.defineProperty(e, t, { value: i, enumerable: !1, writable: !0, configurable: !0 });
    ...
    function P(e, t) {
        ...
        var i = A(e, t);
        if ((i.strictMath && (i.math = g.PARENS), i.relativeUrls && (i.rewriteUrls = w), "string" == typeof i.math))
    ...
    (V.prototype.constructor = V),
        (V.prototype.toString = function (e) {
            ...
            return (
                ...
                (t += "\n" + n),
                this.callLine && ((t += r("from ", "red") + (this.filename || "") + "/n"), (t += r(this.callLine, "grey") + " " + this.callExtract + "/n")),
                t
            );
        });
    var $ = { visitDeeper: !0 },
            ...
            return (
                ...
                (e.prototype.flatten = function (e, t) {
                    ...
                    for (t || (t = []), n = 0, i = e.length; n < i; n++)
                        if (void 0 !== (r = e[n]))
                            if (r.splice) for (o = 0, s = r.length; o < s; o++) void 0 !== (a = r[o]) && (a.splice ? a.length && this.flatten(a, t) : t.push(a));
                            else t.push(r);
                    return t;
                }),
                e
            ...
            return (
                ...
                (e.prototype.visit = function (e) {
                    return e
                        ? e.constructor === Array
                            ? this.visitArray(e)
                            : (!e.blocksVisibility || e.blocksVisibility() || (this.visible ? e.ensureVisibility() : e.ensureInvisibility(), e.accept(this)), e)
                        : e;
                }),
                e
            );
            ...
            return (
                                    ...
                                    (s = f.findMatch(l, a)).length &&
                                        ...
                                        l.selfSelectors.forEach(function (e) {
                                            ...
                                            (o = f.extendSelector(s, a, e, l.isVisible())),
                                                ((c = new He.Extend(u.selector, u.option, 0, u.fileInfo(), t)).selfSelectors = o),
                                                (o[o.length - 1].extendList = [c]),
                                                h.push(c),
                                                (c.ruleset = u.ruleset),
                                                (c.parent_ids = c.parent_ids.concat(u.parent_ids, l.parent_ids)),
                                                u.firstExtendOnThisSelectorPath && ((c.firstExtendOnThisSelectorPath = !0), u.ruleset.paths.push(o));
                                        })));
                    if (h.length) {
                ...
                (e.prototype.findMatch = function (e, t) {
                    ...
                    for (i = 0; i < t.length; i++)
                        for (n = t[i], r = 0; r < n.elements.length; r++)
                            for (
                                s = n.elements[r], (e.allowBefore || (0 === i && 0 === r)) && c.push({ pathIndex: i, index: r, matched: 0, initialCombinator: s.combinator }), a = 0;
                                a < c.length;
                                a++
                            )
                                (l = c[a]),
                                    ...
                                    l && ((l.finished = l.matched === u.length), l.finished && !e.allowAfter && (r + 1 < n.elements.length || i + 1 < t.length) && (l = null)),
                                    l ? l.finished && ((l.length = u.length), (l.endPathIndex = i), (l.endPathElementIndex = r + 1), (c.length = 0), h.push(l)) : (c.splice(a, 1), a--);
                    return h;
                }),
                ...
                (e.prototype.extendSelector = function (e, t, i, n) {
                    ...
                    for (r = 0; r < e.length; r++)
                        (s = t[(a = e[r]).pathIndex]),
                            (o = new He.Element(a.initialCombinator, i.elements[0].value, i.elements[0].isVariable, i.elements[0].getIndex(), i.elements[0].fileInfo())),
                            ...
                            u === a.pathIndex && r > 0 ? (h[h.length - 1].elements = h[h.length - 1].elements.concat(l)) : (h = h.concat(t.slice(u, a.pathIndex))).push(new He.Selector(l)),
                            (u = a.endPathIndex),
                            (c = a.endPathElementIndex) >= t[u].elements.length && ((c = 0), u++);
                    return (
                        u < t.length && c > 0 && ((h[h.length - 1].elements = h[h.length - 1].elements.concat(t[u].elements.slice(c))), u++),
            ...
            if (e)
                for (var i = 0; i < e.length; i++) {
                    ...
                    if (t && n instanceof He.Declaration && !n.variable)
                        throw { message: "Properties must be inside selector blocks. They cannot be in the root", index: n.getIndex(), filename: n.fileInfo() && n.fileInfo().filename };
                    if (n instanceof He.Call) throw { message: "Function '" + n.name + "' did not return a root node", index: n.getIndex(), filename: n.fileInfo() && n.fileInfo().filename };
                    if (n.type && !n.allowRoot) throw { message: n.type + " node returned by a function is not valid here", index: n.getIndex(), filename: n.fileInfo() && n.fileInfo().filename };
                }
        },
        visitRuleset: function (e, t) {
            var i,
        ...
        _compileRulesetPaths: function (e) {
            e.paths &&
                (e.paths = e.paths.filter(function (e) {
                    var t;
                    for (" " === e[0].elements[0].combinator.value && (e[0].elements[0].combinator = new He.Combinator("")), t = 0; t < e.length; t++)
    ...
    var Y = { Visitor: N, ImportVisitor: W, MarkVisibleSelectorsVisitor: J, ExtendVisitor: Q, JoinSelectorVisitor: K, ToCSSVisitor: X };
    var ee = function () {
        var e,
            t,
            i,
            ...
            for (var n, a, c, h = l.i, f = t, p = l.i - o, v = l.i + s.length - p, d = (l.i += i), m = e; l.i < v; l.i++) {
                if (((n = m.charCodeAt(l.i)), l.autoCommentAbsorb && 47 === n)) {
                    ...
                    if ("*" === a) {
                        ...
                        if (y >= 0) {
                            (c = { index: l.i, text: m.substr(l.i, y + 2 - l.i), isLineComment: !1 }), (l.i += c.text.length - 1), l.commentStore.push(c);
                            continue;
                        }
                    }
                    break;
        ...
        return (
                              ...
                              for (o = 0; o < h; o++)
                                  if (!(((l = e.charCodeAt(o)) >= 97 && l <= 122) || l < 34))
                                      switch (l) {
                                          ...
                                          case 47:
                                              if (p || o == h - 1) continue;
                                              if (47 == (u = e.charCodeAt(o + 1))) for (o += 2; o < h && (!((u = e.charCodeAt(o)) <= 13) || (10 != u && 13 != u)); o++);
                                              else if (42 == u) {
            ...
            (l.end = function () {
                var t,
                    r = l.i >= e.length;
                return l.i < i && ((t = n), (l.i = i)), { isFinished: r, furthest: l.i, furthestPossibleErrorMessage: t, furthestReachedEnd: l.i >= e.length - 1, furthestChar: e[l.i] };
            }),
            l
        );
    };
        ...
        re = function e(t, i, n, r) {
            ...
            return {
                ...
                parse: function (r, l, u) {
                    ...
                    (h || (u && u.banner)) && ((d = (u && u.banner ? u.banner : "") + h), ((p = i.contentsIgnoredChars)[n.filename] = p[n.filename] || 0), (p[n.filename] += d.length)),
                        (r = d + (r = r.replace(/\r\n?/g, "\n")).replace(/^\uFEFF/, "") + f),
                    ...
                    if (!y.isFinished) {
                        ...
                        b ||
                            ...
                            "}" === y.furthestChar
                                ...
                                : ")" === y.furthestChar
                                ? (b += ". Possibly missing opening '('")
                                : y.furthestReachedEnd && (b += ". Possibly missing something")),
                            (v = new V({ type: "Parse", message: b, index: y.furthest, filename: n.filename }, i));
                    }
                    var w = function (e) {
                ...
                parsers: (s = {
                    ...
                    entities: {
                        ...
                        url: function () {
                            ...
                            if (((o.autoCommentAbsorb = !1), o.$str("url(")))
                                return (
                                    (e = this.quoted() || this.variable() || this.property() || o.$re(/^(?:(?:\\[()'"])|[^()'"])+/) || ""),
                                    (o.autoCommentAbsorb = !0),
                                    u(")"),
                                    new He.URL(void 0 !== e.value || e instanceof He.Variable || e instanceof He.Property ? e : new He.Anonymous(e, t), t + r, n)
                                );
                            o.autoCommentAbsorb = !0;
                        },
                        variable: function () {
                        ...
                        color: function () {
                            var e;
                            if ((o.save(), "#" === o.currentChar() && (e = o.$re(/^#([A-Fa-f0-9]{8}|[A-Fa-f0-9]{6}|[A-Fa-f0-9]{3,4})([\w.#[])?/)) && !e[2]))
                    ...
                    mixin: {
                        ...
                        elements: function () {
                            for (var e, t, i, s, a, l = /^[#.](?:[\w-]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+/; (a = o.i), (t = o.$re(l)); )
                                (s = new He.Element(i, t, !1, a + r, n)), e ? e.push(s) : (e = [s]), (i = o.$char(">"));
                            return e;
                        },
                        args: function (e) {
                            var t,
                            ...
                            for (o.save(); ; ) {
                                ...
                                var g = null;
                                if ((e ? u.value && 1 == u.value.length && (g = u.value[0]) : (g = u), g && (g instanceof He.Variable || g instanceof He.Property)))
                                    if (o.$char(":")) {
                                        ...
                                        if (!e) {
                                            (f.variadic = !0), o.$char(";") && !t && (t = !0), (t ? v : d).push({ name: u.name, variadic: !0 });
                                            break;
                                        }
                                        c = !0;
                        ...
                        definition: function () {
                            ...
                            if (!(("." !== o.currentChar() && "#" !== o.currentChar()) || o.peek(/^[^{]*\}/)))
                                if ((o.save(), (t = o.$re(/^([#.](?:[\w-]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+)\s*\(/)))) {
                                    ...
                                    if (((o.commentStore.length = 0), o.$str("when") && (n = l(s.conditions, "expected condition")), (i = s.block())))
                    ...
                    ieAlpha: function () {
                        var e;
                        if (o.$re(/^opacity=/i))
                            return (e = o.$re(/^\d+/)) || (e = "@{" + (e = l(s.entities.variable, "Could not parse alpha")).name.slice(1) + "}"), u(")"), new He.Quoted("", "alpha(opacity=" + e + ")");
                    },
                    element: function () {
                        var e,
                            t,
                        ...
                        if (
                            ...
                            (e =
                                ...
                                (o.save(), o.$char("(") ? ((i = this.selector(!1)) && o.$char(")") ? ((e = new He.Paren(i)), o.forget()) : o.restore("Missing closing ')'")) : o.forget()),
                            e)
                        )
                    ...
                    selector: function (e) {
                        ...
                        for (
                            e = !1 !== e;
                            ((e && (i = this.extend())) || (e && (h = o.$str("when"))) || (u = this.element())) &&
                            (h
                                ...
                                : i
                                ? (c = c ? c.concat(i) : i)
                                : (c && a("Extend can only be used at the end of selector"), (s = o.currentChar()), t ? t.push(u) : (t = [u]), (u = null)),
                            "{" !== s && "}" !== s && ";" !== s && "," !== s && ")" !== s);
                    ...
                    selectors: function () {
                        for (
                            var e, t;
                            (e = this.selector()) &&
                            (t ? t.push(e) : (t = [e]), (o.commentStore.length = 0), e.condition && t.length > 1 && a("Guards are only currently allowed on a single selector."), o.$char(","));

                        )
                            e.condition && a("Guards are only currently allowed on a single selector."), (o.commentStore.length = 0);
                        return t;
                    },
                    attribute: function () {
                        if (o.$char("[")) {
                            var e,
                                ...
                                r = this.entities;
                            return (
                                (e = r.variableCurly()) || (e = l(/^(?:[_A-Za-z0-9-*]*\|)?(?:[_A-Za-z0-9-]|\\.)+/)),
                                (i = o.$re(/^[|~*$^]?=/)) && (t = r.quoted() || o.$re(/^[0-9]+%/) || o.$re(/^[\w-]+/) || r.variableCurly()) && (n = o.$re(/^[iIsS]/)),
                                u("]"),
                        ...
                        if ("." !== c && "#" !== c && "&" !== c && ":" !== c)
                            if ((o.save(), (e = this.variable() || this.ruleProperty()))) {
                                if (((l = "string" == typeof e) && (t = this.detachedRuleset()) && (i = !0), (o.commentStore.length = 0), !t)) {
                                    if (((a = !l && e.length > 1 && e.pop().value), (t = e[0].value && "--" === e[0].value.slice(0, 2) ? this.permissiveValue(/[;}]/) : this.anonymousValue())))
                                        return o.forget(), new He.Declaration(e, t, !1, a, u + r, n);
                        ...
                        if (s) {
                            ...
                            if ((e = this.entities.quoted() || this.entities.url()))
                                return (
                                    ...
                                    o.$char(";") || ((o.i = i), a("missing semi-colon or unrecognised media features on import")),
                                    (t = t && new He.Value(t)),
                        ...
                        do {
                            (t = l.keyword() || l.variable() || l.mixinLookup())
                                ...
                                : o.$char("(") &&
                                  ((i = this.property()),
                                  o.save(),
                                  !i && e.queryInParens && o.$re(/^[0-9a-z-]*\s*([<>]=|<=|>=|[<>]|=)/)
                                      ? (o.restore(), (i = this.condition()), o.save(), (s = this.atomicCondition(null, i.rvalue)) || o.restore())
                                      : (o.restore(), (t = this.value())),
                                  o.$char(")")
                                      ? i && !t
                                          ? (u.push(new He.Paren(new He.QueryInParens(i.op, i.lvalue, i.rvalue, s ? s.op : null, s ? s.rvalue : null, i._index))), (t = i))
                                          : i && t
                                          ? u.push(new He.Paren(new He.Declaration(i, t, null, null, o.i + r, n, !0)))
                                          : t
                    ...
                    plugin: function () {
                        var e,
                            ...
                            s = o.i;
                        if (o.$re(/^@plugin\s+/)) {
                            if (((i = (t = this.pluginArgs()) ? { pluginArgs: t, isPlugin: !0 } : { isPlugin: !0 }), (e = this.entities.quoted() || this.entities.url())))
                                return o.$char(";") || ((o.i = s), a("missing semi-colon on @plugin")), new He.Import(e, null, i, s + r, n);
                            ...
                            if ((o.save(), (e = o.$re(/^@[a-z-]+/)))) {
                                ...
                                if (
                                    ...
                                    u
                                        ...
                                        : h
                                        ? (i = this.expression()) || a("expected " + e + " expression")
                                        : f &&
                                          ((i = this.permissiveValue(/^[{;]/)),
                                          (v = "{" === o.currentChar()),
                                          i ? i.value || (i = null) : v || ";" === o.currentChar() || a(e + " rule is missing block or ending semi-colon")),
                                    v && (s = this.blockRuleset()),
                                    s || (!v && i && o.$char(";")))
                                )
                                    return o.forget(), new He.AtRule(e, i, s, p + r, n, t.dumpLineNumbers ? c(p) : null, d);
                    ...
                    addition: function () {
                        ...
                        if ((e = this.multiplication())) {
                            for (r = o.isWhitespace(-1); (i = o.$re(/^[-+]\s+/) || (!r && (o.$char("+") || o.$char("-")))) && (t = this.multiplication()); )
                                (e.parensInOp = !0), (t.parensInOp = !0), (n = new He.Operation(i, [n || e, t], r)), (r = o.isWhitespace(-1));
                            return n || e;
                        }
                    },
                    conditions: function () {
                    ...
                    atomicCondition: function (e, t) {
                        ...
                        if ((i = t || h()))
                            return (
                                o.$char(">") ? (l = o.$char("=") ? ">=" : ">") : o.$char("<") ? (l = o.$char("=") ? "<=" : "<") : o.$char("=") && (l = o.$char(">") ? "=>" : o.$char("<") ? "=<" : "="),
                                l ? ((n = h()) ? (s = new He.Condition(l, i, n, c + r, !1)) : a("expected expression")) : t || (s = new He.Condition("=", i, new He.Keyword("true"), c + r, !1)),
                                s
                            );
                    },
                    operand: function () {
                    ...
                    expression: function () {
                        ...
                        do {
                            (e = this.comment())
                                ? i.push(e)
                                : ((e = this.addition() || this.entity()) instanceof He.Comment && (e = null),
                                  e && (i.push(e), o.peek(/^\/[/*]/) || ((t = o.$char("/")) && i.push(new He.Anonymous(t, n + r)))));
                        } while (e);
                    ...
                    ruleProperty: function () {
                        ...
                        for (l(/^(\*?)/); l(/^((?:[\w-]+)|(?:[@$]\{[\w-]+\}))/); );
                        if (i.length > 1 && l(/^((?:\+_|\+)?)\s*:/)) {
                            for (o.forget(), "" === i[0] && (i.shift(), s.shift()), t = 0; t < i.length; t++)
                                (e = i[t]),
                                    (i[t] =
    ...
    se.prototype = Object.assign(new u(), {
        ...
        getElements: function (e) {
            return e
                ? ("string" == typeof e &&
                      new re(this.parse.context, this.parse.importManager, this._fileInfo, this._index).parseNode(e, ["selector"], function (t, i) {
    ...
    ce.prototype = Object.assign(new u(), {
        ...
        eval: function (e) {
            ...
            "string" != typeof r &&
                ...
                (s = !1)),
                "font" === r && e.math === ue.ALWAYS && ((n = !0), (t = e.math), (e.math = ue.PARENS_DIVISION));
            try {
                if ((e.importantScope.push({}), (i = this.value.eval(e)), !this.variable && "DetachedRuleset" === i.type))
                    throw { message: "Rulesets cannot be evaluated on a property.", index: this.getIndex(), filename: this.fileInfo().filename };
    ...
    me.prototype = Object.assign(new u(), {
        ...
        eval: function (e) {
            ...
            if (this.selectors && (i = this.selectors.length)) {
                for (t = new Array(i), de.error({ type: "Syntax", message: "it is currently only allowed in parametric mixin guards," }), r = 0; r < i; r++) {
            ...
            for (r = 0; (f = y[r]); r++)
                if (f instanceof me && f.selectors && 1 === f.selectors.length && f.selectors[0] && f.selectors[0].isJustParentSelector()) {
                    y.splice(r--, 1);
            ...
            function i(e) {
                return e.value instanceof le && !e.parsed
                    ? ("string" == typeof e.value.value
                          ? new re(this.parse.context, this.parse.importManager, e.fileInfo(), e.value.getIndex()).parseNode(e.value.value, ["value", "important"], function (t, i) {
        ...
        genCSS: function (e, t) {
            ...
            for (i = 0; (s = this.rules[i]); i++)
                s instanceof ve ? (f === i && f++, a.push(s)) : s.isCharset && s.isCharset() ? (a.splice(h, 0, s), h++, f++) : "Import" === s.type ? (a.splice(f, 0, s), f++) : a.push(s);
            if (((a = [].concat(a)), !this.root)) {
                ...
                var p = this.paths,
                    ...
                    d = void 0;
                for (l = e.compress ? "," : ",\n" + c, i = 0; i < v; i++)
                    if ((d = (o = p[i]).length)) for (i > 0 && t.add(l), e.firstSelector = !0, o[0].genCSS(e, t), e.firstSelector = !1, n = 1; n < d; n++) o[n].genCSS(e, t);
                t.add((e.compress ? "{" : " {\n") + u);
            }
            for (i = 0; (s = a[i]); i++) {
        ...
        joinSelector: function (e, t, i) {
            ...
            function a(e, t) {
                var i, n;
                if (0 !== e.length)
                    if (0 !== t.length) for (i = 0; (n = t[i]); i++) n.length > 0 ? (n[n.length - 1] = n[n.length - 1].createDerived(n[n.length - 1].elements.concat(e))) : n.push(new se(e));
    ...
    var ge = function (e, t, i, n, r, s, o, a) {
        ...
        if (((this.name = e), (this.value = t instanceof u ? t : t ? new le(t) : t), i)) {
            for (Array.isArray(i) ? (this.rules = i) : ((this.rules = [i]), (this.rules[0].selectors = new se([], null, null, n, r).createEmptySelectors())), l = 0; l < this.rules.length; l++)
    ...
    ge.prototype = Object.assign(new u(), {
        ...
        eval: function (e) {
            ...
            return (
                ...
                (e.mediaPath = t),
                (e.mediaBlocks = i),
                new ge(this.name, n, r, this.getIndex(), this.fileInfo(), this.debugInfo, this.isRooted, this.visibilityInfo())
            );
        },
        variable: function (e) {
        ...
        operate: function (e, t, i) {
            ...
            if ("+" === t || "-" === t)
                if (0 === r.numerator.length && 0 === r.denominator.length) (r = i.unit.clone()), this.unit.backupUnit && (r.backupUnit = this.unit.backupUnit);
                    ...
                    if (((i = i.convertTo(this.unit.usedUnits())), e.strictUnits && i.unit.toString() !== r.toString()))
                ...
                "*" === t
                    ? ((r.numerator = r.numerator.concat(i.unit.numerator).sort()), (r.denominator = r.denominator.concat(i.unit.denominator).sort()), r.cancel())
                    : "/" === t && ((r.numerator = r.numerator.concat(i.unit.denominator).sort()), (r.denominator = r.denominator.concat(i.unit.numerator).sort()), r.cancel());
            return new we(n, r);
        },
        compare: function (e) {
            var t, i;
    ...
    Se.prototype = Object.assign(new u(), {
        ...
        eval: function (e) {
            ...
            if (e.isMathOn(this.op)) {
                if (
                    ((t = "./" === this.op ? "/" : this.op), i instanceof we && n instanceof c && (i = i.toColor()), n instanceof we && i instanceof c && (n = n.toColor()), !i.operate || !n.operate)
                ) {
        ...
        eval: function (e) {
            ...
            return (
                ...
                this.value.length > 1
                    ...
                    : 1 === this.value.length
                    ? (!this.value[0].parens || this.value[0].parensInOp || e.inCalc || (r = !0), (t = this.value[0].eval(e)))
                    : (t = this),
                n && e.outOfParenthesis(),
                !this.parens || !this.parensInOp || i || r || t instanceof we || (t = new p(t)),
                t
            );
        },
        genCSS: function (e, t) {
    ...
    Ae.prototype = Object.assign(new u(), {
        ...
        eval: function (e) {
            var t,
                i = this.name;
            if ((0 === i.indexOf("@@") && (i = "@" + new Ae(i.slice(1), this.getIndex(), this.fileInfo()).eval(e).value), this.evaluating))
                throw { type: "Name", message: "Recursive variable definition for " + i, filename: this.fileInfo().filename, index: this.getIndex() };
            if (
                ((this.evaluating = !0),
            ...
            throw { type: "Name", message: "variable " + i + " is undefined", filename: this.fileInfo().filename, index: this.getIndex() };
        },
        find: function (e, t) {
    ...
    Re.prototype = Object.assign(new u(), {
        ...
        eval: function (e) {
            ...
            if (
                !this.isEvald &&
                ("string" == typeof (t = this.fileInfo() && this.fileInfo().rootpath) && "string" == typeof i.value && e.pathRequiresRewrite(i.value)
                    ? (i.quote ||
    ...
    var Fe = function (e, t, i, n, r, s) {
        if (((this.options = i), (this._index = n), (this._fileInfo = r), (this.path = e), (this.features = t), (this.allowRoot = !0), void 0 !== this.options.less || this.options.inline))
    ...
    Fe.prototype = Object.assign(new u(), {
        ...
        genCSS: function (e, t) {
            this.css &&
                ...
                (t.add("@import ", this._fileInfo, this._index), this.path.genCSS(e, t), this.features && (t.add(" "), this.features.genCSS(e, t)), t.add(";"));
        },
        getPath: function () {
        ...
        doEval: function (e) {
            ...
            if (this.options.inline) {
                var r = new le(this.root, 0, { filename: this.importedFilename, reference: this.path._fileInfo && this.path._fileInfo.reference }, !0, !0);
    ...
    $e.prototype = Object.assign(new u(), {
        evaluateJavaScript: function (e, t) {
            ...
            try {
                ...
                throw { message: "JavaScript evaluation error: " + t.message + " from `" + e + "`", filename: this.fileInfo().filename, index: this.getIndex() };
            }
            ...
            try {
                ...
                throw { message: "JavaScript evaluation error: '" + e.name + ": " + e.message.replace(/["]/g, "'") + "'", filename: this.fileInfo().filename, index: this.getIndex() };
            }
            return i;
        },
        jsify: function (e) {
    ...
    Ge.prototype = Object.assign(new u(), {
        ...
        eval: function (e) {
            ...
            for (t = 0; t < this.lookups.length; t++) {
                if (((i = this.lookups[t]), Array.isArray(n) && (n = new me([new se()], n)), "" === i)) n = n.lastDeclaration();
                else if ("@" === i.charAt(0)) {
                    if (("@" === i.charAt(1) && (i = "@" + new Ae(i.substr(1)).eval(e).value), n.variables && (n = n.variable(i)), !n))
                        throw { type: "Name", message: "variable " + i + " not found", filename: this.fileInfo().filename, index: this.getIndex() };
                } else {
                    if (((i = "$@" === i.substring(0, 2) ? "$" + new Ae(i.substr(1)).eval(e).value : "$" === i.charAt(0) ? i : "$" + i), n.properties && (n = n.property(i)), !n))
                        throw { type: "Name", message: 'property "' + i.substr(1) + '" not found', filename: this.fileInfo().filename, index: this.getIndex() };
                    n = n[n.length - 1];
                }
    ...
    var We = function (e, t, i, n, r, s, o) {
        (this.name = e || "anonymous mixin"),
            (this.selectors = [new se([new m(null, e, !1, this._index, this._fileInfo)])]),
            (this.params = t),
            (this.condition = n),
            (this.variadic = r),
            (this.arity = t.length),
    ...
    We.prototype = Object.assign(new me(), {
        ...
        evalParams: function (e, t, i, n) {
            var r,
                ...
                p = k(this.params),
                v = 0;
            if ((t.frames && t.frames[0] && t.frames[0].functionRegistry && (f.functionRegistry = t.frames[0].functionRegistry.inherit()), (t = new D.Eval(t, [f].concat(t.frames))), i))
                ...
                if (!n[o]) {
                    if (((s = i && i[h]), (u = p[o].name)))
                        if (p[o].variadic) {
                            ...
                            if ((l = s && s.value)) l = Array.isArray(l) ? new ye(new me("", l)) : l.eval(e);
                            else {
        ...
        matchCondition: function (e, t) {
            return !(
                this.condition &&
                !this.condition.eval(new D.Eval(t, [this.evalParams(t, new D.Eval(t, this.frames ? this.frames.concat(t.frames) : t.frames), e, [])].concat(this.frames || []).concat(t.frames)))
            );
        },
    ...
    Je.prototype = Object.assign(new u(), {
        ...
        eval: function (e) {
            ...
            for (this.selector = this.selector.eval(e), o = 0; o < this.arguments.length; o++)
                if (((s = (r = this.arguments[o]).value.eval(e)), r.expand && Array.isArray(s.value))) for (s = s.value, a = 0; a < s.length; a++) m.push({ value: s[a] });
                ...
                if ((t = e.frames[o].find(this.selector, null, d)).length > 0) {
                    for (c = !0, a = 0; a < t.length; a++) {
                        for (i = t[a].rule, n = t[a].path, u = !1, l = 0; l < e.frames.length; l++)
                            if (!(i instanceof We) && i === (e.frames[l].originalRuleset || e.frames[l])) {
                                u = !0;
                                break;
                            }
                    ...
                    if (p[0] > 0) f = 2;
                        ...
                        throw { type: "Runtime", message: "Ambiguous use of `default()` found when matching for `" + this.format(m) + "`", index: this.getIndex(), filename: this.fileInfo().filename };
            ...
            throw c
                ? { type: "Runtime", message: "No matching definition was found for `" + this.format(m) + "`", index: this.getIndex(), filename: this.fileInfo().filename }
                : { type: "Name", message: this.selector.toCSS().trim() + " is undefined", index: this.getIndex(), filename: this.fileInfo().filename };
        },
        ...
        Ke = (function () {
            ...
            return (
                (e.prototype.evalPlugin = function (e, t, i, n, r) {
                    ...
                    try {
                        new Function("module", "require", "registerPlugin", "functions", "tree", "less", "fileInfo", e)(
                            a,
                            this.require(u),
                            function (e) {
                                o = e;
                ...
                (e.prototype.validatePlugin = function (e, t, i) {
                    return e
                        ? ("function" == typeof e && (e = new e()),
                          e.minVersion && this.compareVersion(e.minVersion, this.less.version) < 0 ? new V({ message: "Plugin " + i + " requires version " + this.versionToString(e.minVersion) }) : e)
                        : null;
                }),
    ...
    var ot = (Ye = {
        ...
        hsla: function (e, t, i, n) {
            ...
            try {
                ...
                (e = (st(e) % 360) / 360), (t = tt(st(t))), (i = tt(st(i))), (n = tt(st(n))), (r = 2 * i - (s = i <= 0.5 ? i * (t + 1) : i + t - i * t));
    ...
    var ct = function (e) {
            ...
            each: function (e, t) {
                ...
                for (var h = 0; h < n.length; h++) {
                    var f = void 0,
                        p = void 0,
                        v = n[h];
                    v instanceof ce ? ((f = "string" == typeof v.name ? v.name : v.name[0].value), (p = v.value)) : ((f = new we(h + 1)), (p = v)),
                        v instanceof ve ||
                            ((i = t.rules.slice(0)),
                            a && i.push(new ce(a, p, !1, !1, this.index, this.currentFileInfo)),
                            c && i.push(new ce(c, new we(h + 1), !1, !1, this.index, this.currentFileInfo)),
                            l && i.push(new ce(l, f, !1, !1, this.index, this.currentFileInfo)),
                            s.push(new me([new se([new m("", "&")])], i, t.strictImports, t.visibilityInfo())));
                }
        ...
        pt = { ceil: null, floor: null, sqrt: null, abs: null, tan: "", sin: "", cos: "", atan: "rad", asin: "rad", acos: "rad" };
    ...
    var dt = function (e, t) {
            ...
            for (i = 0; i < t.length; i++)
                if ((r = t[i]) instanceof we)
                    if (
                        ((l =
                            ("" !== (a = "" === (s = "" === r.unit.toString() && void 0 !== u ? new we(r.value, u).unify() : r.unify()).unit.toString() && void 0 !== l ? l : s.unit.toString()) &&
                                void 0 === l) ||
                            ("" !== a && "" === h[0].unify().unit.toString())
                                ? a
                                : l),
                        (u = "" !== a && void 0 === u ? r.unit.toString() : u),
                        void 0 !== (n = void 0 !== f[""] && "" !== a && a === l ? f[""] : f[a]))
                    )
                        (o = "" === h[n].unit.toString() && void 0 !== u ? new we(h[n].value, u).unify() : h[n].unify()), ((e && s.value < o.value) || (!e && s.value > o.value)) && (h[n] = r);
                    else {
        ...
        mt = {
            ...
            pow: function (e, t) {
                if ("number" == typeof e && "number" == typeof t) (e = new we(e)), (t = new we(t));
                else if (!(e instanceof we && t instanceof we)) throw { type: "Argument", message: "arguments must be numbers" };
        ...
        wt = {
            ...
            isunit: bt,
            unit: function (e, t) {
                if (!(e instanceof we)) throw { type: "Argument", message: "the first argument to unit must be a number" + (e instanceof Se ? ". Have you forgotten parenthesis?" : "") };
            ...
            return (
                ...
                te.addMultiple({
                    "svg-gradient": function (e) {
                        ...
                        switch (
                            (2 == arguments.length ? (arguments[1].value.length < 2 && v(), (t = arguments[1].value)) : arguments.length < 3 ? v() : (t = Array.prototype.slice.call(arguments, 1)), p)
                        ) {
                            case "to bottom":
                        ...
                        for (n = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1 1"><' + u + 'Gradient id="g" ' + i + ">", r = 0; r < t.length; r += 1)
                            t[r] instanceof Ce ? ((s = t[r].value[0]), (o = t[r].value[1])) : ((s = t[r]), (o = void 0)),
                                (s instanceof c && (((0 === r || r + 1 === t.length) && void 0 === o) || o instanceof we)) || v(),
                        ...
                        return (
                            ...
                            new Re(new Ee("'" + (n = "data:image/svg+xml," + n) + "'", n, !1, this.index, this.currentFileInfo), this.index, this.currentFileInfo)
                        );
                    },
                }),
                te.addMultiple(wt),
    ...
    var _t,
        ...
        Pt = function (e) {
            ...
            return { major: parseInt(t[1], 10), minor: parseInt(t[2], 10), patch: parseInt(t[3], 10), pre: t[4] || "", build: t[5] || "" };
        };
    function Mt(e, t) {
        var i, n, o, a;
        (o = (function (e) {
            return (function () {
                ...
                return (
                    (t.prototype.toCSS = function (t) {
                        ...
                        for (var c in (t.sourceMap && (s.map = n.getExternalSourceMap()), (s.imports = []), this.imports.files))
                            Object.prototype.hasOwnProperty.call(this.imports.files, c) && c !== this.imports.rootFilename && s.imports.push(c);
                        return s;
                    }),
                    t
                );
                            ...
                            (this._css = []),
                                ...
                                t.sourceMapRootpath
                                    ? ((this._sourceMapRootpath = t.sourceMapRootpath.replace(/\\/g, "/")),
                                      "/" !== this._sourceMapRootpath.charAt(this._sourceMapRootpath.length - 1) && (this._sourceMapRootpath += "/"))
                            ...
                            (t.prototype.removeBasepath = function (e) {
                                return (
                                    this._sourceMapBasepath &&
                                        ...
                                        (("\\" !== (e = e.substring(this._sourceMapBasepath.length)).charAt(0) && "/" !== e.charAt(0)) || (e = e.substring(1))),
                                    e
                                );
                            }),
                                    ...
                                    if (t && t.filename) {
                                        ...
                                        if (
                                            (this._contentsIgnoredCharsMap[t.filename] &&
                                                ((i -= this._contentsIgnoredCharsMap[t.filename]) < 0 && (i = 0), (u = u.slice(this._contentsIgnoredCharsMap[t.filename]))),
                                            void 0 === u)
                                        )
                                        ...
                                        if (n)
                                            for (l = 0; l < r.length; l++)
                                                this._sourceMapGenerator.addMapping({
                                                    generated: { line: this._lineNumber + l + 1, column: 0 === l ? this._column : 0 },
                    ...
                    return (
                        (t.prototype.push = function (t, i, n, s, o) {
                            ...
                            var u = function (e, i, n) {
                                    ...
                                    s.optional && e
                                        ? (o(null, { rules: [] }, !1, null), r.info("The file " + n + " was skipped because it was not found and the import was marked optional."))
                                        : (a.files[n] || s.inline || (a.files[n] = { root: i, options: s }), e && !a.error && (a.error = e), o(e, i, l, n));
                                },
                                ...
                                var f,
                                    ...
                                    v = function (e) {
                                        ...
                                        (c.currentDirectory = h.getPath(i)),
                                            c.rewriteUrls &&
                                                ((c.rootpath = h.join(a.context.rootpath || "", h.pathDiff(c.currentDirectory, c.entryPath))),
                                        ...
                                        (o.processImports = !1),
                                            ...
                                            s.isPlugin
                                                ? (t = l.evalPlugin(r, o, a, s.pluginArgs, c)) instanceof V
                                                    ? u(t, null, i)
                                                    : u(null, t, i)
                                                : s.inline
                                                ? u(null, r, i)
                                ...
                                i && (d.ext = s.isPlugin ? ".js" : ".less"),
                                    s.isPlugin
                                        ? ((d.mime = "application/javascript"),
                                          d.syncImport ? (f = l.loadPluginSync(t, n.currentDirectory, d, e, h)) : (p = l.loadPlugin(t, n.currentDirectory, d, e, h)))
                                        : d.syncImport
        ...
        var u,
            ...
            h = (function (e, t, i) {
                var n = function (e, t, r) {
                    ...
                    if (((t.pluginManager = l), (o = new D.Parse(t)), t.rootFileInfo)) a = t.rootFileInfo;
                    else {
                        var u = t.filename || "input",
                            c = u.replace(/[^/\\]*$/, "");
                        (a = { filename: u, rewriteUrls: o.rewriteUrls, rootpath: o.rootpath || "", currentDirectory: c, entryPath: c, rootFilename: u }).rootpath &&
                            "/" !== a.rootpath.slice(-1) &&
                            (a.rootpath += "/");
                    }
    ...
    var Ft = function (t, n, r) {
            return {
                add: function (s, o) {
                    r.errorReporting && "html" !== r.errorReporting
                        ...
                        : (function (n, s) {
                              ...
                              n.line && (p(n, 0, ""), p(n, 1, "line"), p(n, 2, ""), (a += "on line " + n.line + ", column " + (n.column + 1) + ":</p><ul>" + c.join("") + "</ul>")),
                ...
                remove: function (i) {
                    r.errorReporting && "html" !== r.errorReporting
                        ? "console" === r.errorReporting || ("function" == typeof r.errorReporting && r.errorReporting("remove", i))
                        : (function (i) {
    ...
    !(function (e, i) {
        t(i, n(e)),
            ...
            (i.env =
                i.env ||
                ("127.0.0.1" == e.location.hostname || "0.0.0.0" == e.location.hostname || "localhost" == e.location.hostname || (e.location.port && e.location.port.length > 0) || i.isFileProtocol
                    ? "development"
                    : "production"));
        ...
        ($t.plugins = $t.plugins || []),
        window.LESS_PLUGINS && ($t.plugins = $t.plugins.concat(window.LESS_PLUGINS));
    var jt,
        Nt,
        Dt,
        Bt = (function (e, n) {
    ...
    return (
        ...
        $t.onReady &&
            ...
            $t.async ||
                ...
                Dt.styleSheet ? (Dt.styleSheet.cssText = jt) : Dt.appendChild(document.createTextNode(jt)),
                Nt.appendChild(Dt)),
            Bt.registerStylesheetsImmediately(),
            (Bt.pageLoadFinished = Bt.refresh("development" === Bt.env).then(Ut, Ut))),
        Bt
    );
});
