describe("standardizer", function () {
    ...
    it("As an Admin, When no sources are selected and compare is clicked, an alert pops up", function () {
        ...
        cy.get("#toolsTreeDiv > .jstree-container-ul > #Standardizer > #Standardizer_anchor").click();
        ...
        cy.get("#actionDivContolPanelDiv > #Standardizer_leftTab > .ui-tabs-nav > .ui-tabs-tab > #standardizer-source-tab").click();
