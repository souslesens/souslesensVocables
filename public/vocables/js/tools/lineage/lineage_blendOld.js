...
var Lineage_blend = (function () {
    ...
    self.createRelationUI = function (type, addImportToCurrentSource, createInverseRelation) {
        ...
        self.createRelation((self.currentSource = node.data.source), type, sourceNode, targetNode, addImportToCurrentSource, createInverseRelation, {}, function (err, _result) {
...
callbackSeries();
    ...
    self.getUpperOntologyObjectPropertiesDescription = function (sourceLabel, reload, callback) {
        ...
        async.series(
            ...
            function (err) {
                Lineage_upperOntologies.objectPropertiesMap[sourceLabel] = allProps;
