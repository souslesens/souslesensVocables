...
mappingsMap = {
    ...
    LOCATIONS: {
        ...
        tripleModels: [
         ...
         {s: "Class", p: "skos:prefLabel", o: "Class", isString: "true"},
            ...
            {s: "Class", p: "iso81346:hasCode", o: function(line,item){
                return "'"+decode81346(line.Class).code+"'"
                }},
            {s: "Class", p: "rdfs:label", o: function(line,item){
            ...
            {s: "Parent_1", p: "iso81346:hasCode", o: function(line,item){
                    return "'"+decode81346(line.Parent_1).code+"'"
                }},
            {s: "Parent_1", p: "rdfs:label", o: function(line,item){
            ...
            {s: "Parent_2", p: "iso81346:hasCode", o: function(line,item){
                    return "'"+decode81346(line.Parent_2).code+"'"
                }},
            {s: "Parent_2", p: "rdfs:label", o: function(line,item){
    ...
    FUNCTIONS_SYS3: {
        ...
        tripleModels: [
            ...
            {s: "Parent_3", p: "iso81346:hasCode", o: function(line,item){
                    return "'"+decode81346(line.Parent_3).code+"'"
                }},
            {s: "Parent_3", p: "rdfs:label", o: function(line,item){
