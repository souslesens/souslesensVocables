...
var DataManager = (function () {
        ...
        self.drawCumulTable = function () {
            ...
            for (var group in groupsChartData) {
                ...
                if(!value){ value=0}
                    ...
                    groupsChartData[group].content;
                    +"</td>";
                    str += "<td class='detailsCellValue' style='padding: 4px 4px'>" +
                    value.toString()
                    +"</td>";
                    str += "<td class='detailsCellValue' style='padding: 4px 4px'>" +
                    groupCounts[group].WBStasksCount
                    +"</td>";
                    str += "<td class='detailsCellValue' style='padding: 4px 4px'>" +
                    groupCounts[group].JCcount
                    +"</td>";
                    str+="</tr>"
                    totalCumul += value;
            ...
            str+="<tr class='infos_table'>"
            str += "<td class='detailsCellName' style='padding: 4px 4px'>" +
                    'Total (Total Unique for Counts)';
                    +"</td>";
                    str += "<td class='detailsCellValue' style='padding: 4px 4px'>" +
                    Math.round(totalCumul).toString()
                    +"</td>";
                    str += "<td class='detailsCellValue' style='padding: 4px 4px'>" +
                    totalUnique.WBStasks
                    +"</td>";
                    str += "<td class='detailsCellValue' style='padding: 4px 4px'>" +
                    totalUnique.JC
                    +"</td>";
        ...
        self.showWBStasksList = function (items, date) {
            ...
            var html = "<B>Total " + DropDuplicatesItems.length + "" + (date ? ("<br>on " + date) : "") +
                "<br>yAxis:" + yAxisVal + "</B>" +
                "<br><table style='width: 400px;'>";
            html += "<tr>"
            html += "<td>WBStask</td>"
            html += "<td>duration</td>"
            html += "<td>" + "yAxis" + "</td>"
            ...
            DropDuplicatesItems.forEach(function (item, index) {
                ...
                html += "<td style='text-decoration: underline;color:"+colorJC+`' onclick=' Simulator.initSimulatorWidget("http://data.total/resource/tsf/dalia-lifex1/"+this.innerHTML);'>` + item["WBS_activity_label"].value + "</td>"
