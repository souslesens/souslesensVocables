        ...
        async.eachSeries(
            ...
            function (slice, callbackEach) {
                ...
                if (part14TopTypes) {
                    ...
                    query += "SELECT distinct ?x ?type  " +
                    strFrom +
                    "  WHERE { ?x rdfs:subClassOf|rdf:type ?type.?type rdf:type ?typeType filter (?typeType not in (owl:Restriction)) "; // filter (?type not in ( <http://souslesens.org/resource/vocabulary/TopConcept>,<http://www.w3.org/2002/07/owl#Class>))"
                }
