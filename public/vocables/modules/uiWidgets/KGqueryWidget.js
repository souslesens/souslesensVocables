  ...
  self.addNode = function(node, nodeEvent) {
    ...
    function getQueryElementHtml(setIndex, queryElementDivId, elementIndex) {
      var html =
        ...
        queryElementDivId +
        "'>" +
        "&nbsp;<button class='btn btn-sm my-1 py-0 btn-outline-primary KGqueryWidget_smallButton' onclick='KGqueryWidget.removeQueryElement( " + setIndex + ", " + elementIndex + ") '>X</button>" +
        "" +
        "</div>";
      return html;
    }
