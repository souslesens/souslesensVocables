...
var R2Gmappings = (function () {
                ...
                contextMenu: function (node, x) {
                    ...
                    if (node.id == "databaseSources") {
                        ...
                        items.mapRow = {
                            ...
                            action: function (_e) {
                                // pb avec source
                                R2Gmappings.mapColumn.showMappingDialog();
                            },
                        };
    ...
    self.removeColumnMappings = function (node) {
        ...
        tableTriples.forEach(function (triple, index) {
            if (triple.s == node.data.id) {
                ...
                self.mapColumn.deleteColumnNode(node);
            }
        });
    ...
    self.removeTableMappings = function (node) {
        ...
        JstreeWidget.setSelectedNodeStyle({ color: "black" });
        self.mapColumn.deleteTableNodes(node);
        self.saveDataSourceMappings();
    };
    ...
    self.graphActions = {
        ...
        showGraphPopupMenu: function (node, point, event) {
            ...
            html += '    <span class="popupMenuItem" onclick="R2Gmappings.mapColumn.showMappingDialog(true);"> Set column Class</span>';
    ...
    self.mapColumn = {
        showMappingDialog: function (addColumnClassType) {
            PopupMenuWidget.hidePopup();
          ...
          return alert("select a field (column)");
            ...
            $("#smallDialogDiv").load("snippets/KGcreator/linkColumnToClassDialog.html", function () {
                $("#LinkColumn_subjectDiv").html(columnNode.text);
        ...
        updateColumnTriplesEditor: function (triples) {
        ...
        addTripleFromPredicateSelectorWidget: function (basicType) {
