                                                ...
                                                async.eachSeries(
                                                    ...
                                                    function (line, callbackEachLines2) {
                                                        ...
                                                        mapping.tripleModels.forEach(function (item) {
                                                            ...
                                                            if (!line[item.s] && !item.subjectIsSpecificUri && item.s.indexOf("$_") != 0) {
                                                                // virtual column or specific url
                                                                return;
                                                            }
                                                            ...
                                                            for (var key in line) {
                                                                if (!allColumns[key]) allColumns[key] = 1;
                                                                line[key] = "" + line[key];
                                                            ...
                                                            //get value for Subject
                                                            {
                                                                if (item.subjectIsSpecificUri) {
                                                                    ...
                                                                    // virtual column
                                                                    if (item.o.indexOf("$_") != 0 && allColumns[item.o] && !line[item.o]) {
