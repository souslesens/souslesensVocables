import {
    ...
    a as _objectWithoutPropertiesLoose$3,
    _ as _extends,
    k as ReactDOM,
    d as React,
    e as Transition,
...
function useBootstrapPrefix(prefix, defaultPrefix) {
    const { prefixes: prefixes2 } = reactExports.useContext(ThemeContext);
    return prefix || prefixes2[defaultPrefix] || defaultPrefix;
}
function useBootstrapBreakpoints() {
    const { breakpoints } = reactExports.useContext(ThemeContext);
    return breakpoints;
}
function useBootstrapMinBreakpoint() {
    const { minBreakpoint } = reactExports.useContext(ThemeContext);
...
const FormCheckInput = /* @__PURE__ */ reactExports.forwardRef(
    (
        ...
        const { controlId } = reactExports.useContext(FormContext$1);
...
const FormCheckLabel = /* @__PURE__ */ reactExports.forwardRef(({ bsPrefix, className, htmlFor, ...props }, ref) => {
    const { controlId } = reactExports.useContext(FormContext$1);
                ...
                children:
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
                        children: [
                            input,
                            hasLabel &&
                                /* @__PURE__ */ jsxRuntimeExports.jsx(FormCheckLabel$1, {
                                    title,
                                    children: label,
                                }),
                            feedback &&
                                /* @__PURE__ */ jsxRuntimeExports.jsx(Feedback$1, {
                                    type: feedbackType,
...
function createWithBsPrefix(prefix, { displayName = pascalCase(prefix), Component, defaultProps } = {}) {
    const BsComponent = /* @__PURE__ */ reactExports.forwardRef(({ className, bsPrefix, as: Tag = Component || "div", ...props }, ref) => {
...
const FormRange = /* @__PURE__ */ reactExports.forwardRef(({ bsPrefix, className, id, ...props }, ref) => {
    const { controlId } = reactExports.useContext(FormContext$1);
...
const FormSelect = /* @__PURE__ */ reactExports.forwardRef(({ bsPrefix, size, htmlSize, className, isValid = false, isInvalid = false, id, ...props }, ref) => {
    const { controlId } = reactExports.useContext(FormContext$1);
...
const Switch = /* @__PURE__ */ reactExports.forwardRef((props, ref) =>
    /* @__PURE__ */ jsxRuntimeExports.jsx(FormCheck$1, {
        ...props,
        ref,
        type: "switch",
    })
...
const FloatingLabel = /* @__PURE__ */ reactExports.forwardRef(({ bsPrefix, className, children, controlId, label, ...props }, ref) => {
...
function useButtonProps({ tagName, disabled: disabled2, href, target, rel, role, onClick, tabIndex = 0, type }) {
    if (!tagName) {
    ...
    const handleClick = (event) => {
        if (disabled2 || (tagName === "a" && isTrivialHref$1(href))) {
    ...
    return [
        {
            ...
            disabled: void 0,
            tabIndex: disabled2 ? void 0 : tabIndex,
            href,
            target: tagName === "a" ? target : void 0,
            "aria-disabled": !disabled2 ? void 0 : disabled2,
...
const Button$2 = /* @__PURE__ */ reactExports.forwardRef((_ref2, ref) => {
    let { as: asProp, disabled: disabled2 } = _ref2,
        props = _objectWithoutPropertiesLoose$2(_ref2, _excluded$2);
...
const Button = /* @__PURE__ */ reactExports.forwardRef(({ as, bsPrefix, variant = "primary", size, active = false, disabled: disabled2 = false, className, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Component, {
        ...
        ref,
        disabled: disabled2,
        className: classNames(className, prefix, active && "active", variant && `${prefix}-${variant}`, size && `${prefix}-${size}`, props.href && disabled2 && "disabled"),
    });
});
...
function renderProgressBar({ min, now, max, label, visuallyHidden, striped, animated, className, style: style2, variant, bsPrefix, ...props }, ref) {
...
const ProgressBar = /* @__PURE__ */ reactExports.forwardRef(({ isChild = false, ...rest }, ref) => {
    const props = {
        min: 0,
        max: 100,
        animated: false,
...
function useUncontrolled(props, config2) {
    return Object.keys(config2).reduce(function (result, fieldName) {
        var _extends2;
        var _ref2 = result,
            defaultValue = _ref2[defaultKey(fieldName)],
            propsValue = _ref2[fieldName],
            rest = _objectWithoutPropertiesLoose$3(_ref2, [defaultKey(fieldName), fieldName].map(_toPropertyKey));
...
const Anchor = /* @__PURE__ */ reactExports.forwardRef((_ref2, ref) => {
    let { onKeyDown } = _ref2,
        props = _objectWithoutPropertiesLoose$1(_ref2, _excluded$1);
...
const TransitionWrapper = /* @__PURE__ */ React.forwardRef(({ onEnter, onEntering, onEntered, onExit, onExiting, onExited, addEndListener, children, childRef, ...props }, ref) => {
...
const Fade = /* @__PURE__ */ reactExports.forwardRef(({ className, children, transitionClasses = {}, onEnter, ...rest }, ref) => {
    const props = {
        in: false,
        timeout: 300,
        mountOnEnter: false,
...
const CloseButton = /* @__PURE__ */ reactExports.forwardRef(({ className, variant, "aria-label": ariaLabel = "Close", ...props }, ref) =>
...
const divWithClassName = (className) =>
    /* @__PURE__ */ reactExports.forwardRef((p2, ref) =>
...
const Alert = /* @__PURE__ */ reactExports.forwardRef((uncontrolledProps, ref) => {
    ...
    const alert = /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        ...
        children: [
            dismissible &&
                /* @__PURE__ */ jsxRuntimeExports.jsx(CloseButton$1, {
                    onClick: handleClose,
...
var PREFIX_TO_STYLE = familyProxy(
    ((_familyProxy = {}),
    _defineProperty$1(_familyProxy, FAMILY_CLASSIC, {
        fa: "solid",
        fas: "solid",
        "fa-solid": "solid",
        far: "regular",
...
var STYLE_TO_PREFIX = familyProxy(
    ((_familyProxy2 = {}),
    _defineProperty$1(_familyProxy2, FAMILY_CLASSIC, {
        solid: "fas",
        regular: "far",
        light: "fal",
        thin: "fat",
...
var PREFIX_TO_LONG_STYLE = familyProxy(
    ((_familyProxy3 = {}),
    _defineProperty$1(_familyProxy3, FAMILY_CLASSIC, {
        fab: "fa-brands",
        fad: "fa-duotone",
        fak: "fa-kit",
        fal: "fa-light",
...
var LONG_STYLE_TO_PREFIX = familyProxy(
    ((_familyProxy4 = {}),
    _defineProperty$1(_familyProxy4, FAMILY_CLASSIC, {
        "fa-brands": "fab",
        "fa-duotone": "fad",
        "fa-kit": "fak",
        "fa-light": "fal",
...
var RESERVED_CLASSES = []
    .concat(FAMILIES, _toConsumableArray$1(prefixes), [
        "2xs",
        "xs",
        "sm",
        "lg",
...
var LONG_STYLE =
    ((_LONG_STYLE = {}),
    _defineProperty$1(_LONG_STYLE, FAMILY_CLASSIC, Object.values(PREFIX_TO_LONG_STYLE[FAMILY_CLASSIC])),
    _defineProperty$1(_LONG_STYLE, FAMILY_SHARP, Object.values(PREFIX_TO_LONG_STYLE[FAMILY_SHARP])),
    _LONG_STYLE);
...
var PREFIXES =
    ((_PREFIXES = {}),
    _defineProperty$1(_PREFIXES, FAMILY_CLASSIC, Object.keys(PREFIX_TO_STYLE[FAMILY_CLASSIC])),
    _defineProperty$1(_PREFIXES, FAMILY_SHARP, Object.keys(PREFIX_TO_STYLE[FAMILY_SHARP])),
    _PREFIXES);
...
var PREFIXES_FOR_FAMILY =
    ...
    _defineProperty$1(_PREFIXES_FOR_FAMILY, FAMILY_CLASSIC, Object.keys(PREFIX_TO_LONG_STYLE[FAMILY_CLASSIC])),
    _defineProperty$1(_PREFIXES_FOR_FAMILY, FAMILY_SHARP, Object.keys(PREFIX_TO_LONG_STYLE[FAMILY_SHARP])),
    _PREFIXES_FOR_FAMILY);
function getCanonicalIcon(values) {
    ...
    var famProps =
        ((_famProps = {}),
        _defineProperty$1(_famProps, FAMILY_CLASSIC, "".concat(config.cssPrefix, "-").concat(FAMILY_CLASSIC)),
        _defineProperty$1(_famProps, FAMILY_SHARP, "".concat(config.cssPrefix, "-").concat(FAMILY_SHARP)),
        _famProps);
...
function classList(props) {
    ...
    var classes =
        ...
        _defineProperty(_classes, "fa-rotate-".concat(rotation), typeof rotation !== "undefined" && rotation !== null && rotation !== 0),
        _defineProperty(_classes, "fa-pull-".concat(pull), typeof pull !== "undefined" && pull !== null),
...
function App() {
    ...
    const [subDirs, setSubDirs] = reactExports.useState([]);
    const [subDir, setSubDir] = reactExports.useState("");
    const [databases, setDatabases] = reactExports.useState([]);
    const [files, setFiles] = reactExports.useState([]);
    const [uploadStatus, setUploadStatus] = reactExports.useState("");
    const [displayNewSubDirForm, setDisplayNewSubDirForm] = reactExports.useState(false);
    const [sources, setSources] = reactExports.useState([]);
    const [selectedNewSource, setSelectedNewSource] = reactExports.useState("");
    const [createDirSuccess, setCreateDirSuccess] = reactExports.useState(false);
    const [selectedDatabase, setSelectedDatabase] = reactExports.useState("_default");
    reactExports.useEffect(() => {
        void fetchSubDirs();
    ...
    const fetchFilesInSubDir = async (subDir2) => {
        const response = await fetch("/api/v1/data/files?dir=CSV/" + subDir2);
        await response.json();
        window.KGcreator.listFiles(subDir2);
    };
    ...
    const handleSubDirChange = (event) => {
        setUploadStatus("");
        setFiles([]);
    ...
    const handleNewSubDirChange = (event) => {
    ...
    const selectDatabaseOrFiles = /* @__PURE__ */ jsxRuntimeExports.jsxs(Form$1.Select, {
        defaultValue: "_default",
        onChange: handleSourceTypeChange,
        "aria-label": "",
        children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "_default", disabled: true, children: "Select source type" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "database", children: "Database" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "files", children: "Files" }),
        ],
    });
    const selectSubDir = /* @__PURE__ */ jsxRuntimeExports.jsxs(Form$1.Select, {
        value: subDir === "" ? "_default" : subDir,
        defaultValue: "_default",
        onChange: handleSubDirChange,
        "aria-label": "Default select example",
        children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "_default", disabled: true, children: "Select directory" }),
            subDirs.map((dir) => {
                return /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: dir, children: dir }, dir);
            }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "_newsubdir", children: "+ Add new directory" }),
        ],
    });
    const selectDatabase = /* @__PURE__ */ jsxRuntimeExports.jsxs(Form$1.Select, {
        defaultValue: "_default",
        value: selectedDatabase,
        onChange: handleDatabaseChange,
        "aria-label": "Select database",
        children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "_default", disabled: true, children: "Select database" }),
            databases.map((database) => {
                return /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: database, children: database }, database);
            }),
        ],
    });
    const browseForm = /* @__PURE__ */ jsxRuntimeExports.jsxs(Form$1.Group, {
        controlId: "formFileMultiple",
        className: "mb-3",
        children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Form$1.Control, { name: "files", type: "file", multiple: true, accept: ".csv,.tsv", onChange: uploadFileHandler }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Form$1.Text, { color: "muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Supported files: CSV" }) }),
        ],
    });
    files.map((file) => {
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
                className: "mb-1",
                children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center", children: file.name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(ProgressBar$1, { now: uploadStatus === "success" ? 100 : 0, label: `${uploadStatus === "success" ? 100 : 0}%` }),
                ],
            },
            file.name
        );
    });
    const uploadButton = /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className: "mb-3",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button$1, {
            variant: "primary",
            onClick: fileSubmitHandler,
            children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(FontAwesomeIcon, { icon: uploadStatus === "success" ? faCheck : uploadStatus === "error" ? faTimes : faFile }),
                " Upload ",
                files.length,
                " ",
    ...
    const newSubDirForm = /* @__PURE__ */ jsxRuntimeExports.jsxs(Form$1.Select, {
        defaultValue: "_default",
        "aria-label": "select-new-source",
        onChange: handleNewSubDirChange,
        children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "_default", disabled: true, children: "Select source" }),
            sources.map((source) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: source, children: source }, source)),
        ],
    });
    const errorMessage = (message) => /* @__PURE__ */ jsxRuntimeExports.jsx(Alert$1, { variant: "danger", children: message });
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container$1, {
        fluid: true,
        children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Row$1, {
                children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Col$1, { className: "mb-3 pe-1", children: selectDatabaseOrFiles }),
                    sourceType === "files" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Col$1, { className: "mb-3 px-1", children: selectSubDir }) : null,
                    sourceType === "database" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Col$1, { className: "mb-3 px-1", children: selectDatabase }) : null,
                ],
            }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Row$1, {
                children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Row$1, {
                children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Col$1, { className: "pe-1", children: displayNewSubDirForm ? newSubDirForm : null }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Col$1, {
                        className: "ps-1",
                        children: displayNewSubDirForm ? /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { onClick: handleClickNewSubDir, variant: "secondary", children: "Add" }) : null,
                    }),
                ],
            }),
        ],
