    ...
    readXlsx: function (filePath, callback) {
        ...
        async.series(
            [
                ...
                function (callbackSeries) {
                    ontologyCTG.readCsv(
                        "D:\\NLP\\rdfs\\Total\\quantum_thesaurusMapping.txt",
                        "\t",
                        null,
                        function (err, result) {
                ...
                function (callbackSeries) {
                    ...
                    function getNewId() {
                        var id =
                            "" +
                            Math.round((Date.now() / 100) * (Math.random() * 1000)) +
                    ...
                    for (var key in entitiesMap) {
                        strEntities +=
                            "<http://data.total.com/resource/ontology/ctg/EntityType/" +
                            key +
                    ...
                    jsonArray.forEach(function (item, index) {
                        ...
                        var paragraphUrl =
                            "<http://data.total.com/resource/ontology/ctg/Paragraph/" +
                            item.ID +
                            ">";
                        ...
                        if (item.Document && item.Document != "") {
                            if (!docsMap[item.Document]) {
                                ...
                                docsMap[item.Document] =
                                    "<http://data.total.com/resource/ontology/ctg/Document/" +
                                    getNewId() +
                                    ">";

                                strDocs +=
                                    docsMap[item.Document] +
                                    " <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http:http://data.total.com/resource/ontology/ctg/DocumentType/" +
                                    "GM_MEC" +
                                    "> .\n";
                                strDocs +=
                                    docsMap[item.Document] +
                                    ' <http://www.w3.org/2000/01/rdf-schema#label> "' +
                                    formatString(item.Document) +
                                    '"@en .\n';
                                ...
                                resourceStr +=
                                    docsMap[item.Document] +
                                    " <http://www.w3.org/2004/02/skos/core#inScheme> <http://data.total.com/resource/ontology/ctg/Document> .\n";
                                ...
                                resourceStr +=
                                    ...
                                    formatString(item.Purpose) +
                                    '" .\n';

                                var domain =
                                    "<http://data.total.com/resource/ontology/ctg/Domain/" +
                                    item.Domain +
                                    ">";
                                var branch =
                                    "<http://data.total.com/resource/ontology/ctg/Branch/" +
                                    item.Domain +
                                    "_" +
                                    item.Branch +
                                    ">";
                                var docType =
                                    "<http://data.total.com/resource/ontology/ctg/Document-type/" +
                                    item.Domain +
                                    "_" +
                                    item.Branch +
                                    "_" +
                              ...
                              var docType = "<http://data.total.com/resource/ontology/ctg/Document-type/" +getNewId() + ">";*/
                                ...
                                if (uniqueResource.indexOf(domain) < 0) {
                                    ...
                                    resourceStr +=
                                        domain +
                                        " <http://www.w3.org/2004/02/skos/core#inScheme> <http://data.total.com/resource/ontology/ctg/Domain> .\n";
                                }
                                if (uniqueResource.indexOf(branch) < 0) {
                                    ...
                                    resourceStr +=
                                        branch +
                                        " <http://www.w3.org/2004/02/skos/core#inScheme> <http://data.total.com/resource/ontology/ctg/Branch> .\n";
                                }
                                if (uniqueResource.indexOf(docType) < 0) {
                                    ...
                                    resourceStr +=
                                        docType +
                                        " <http://www.w3.org/2004/02/skos/core#inScheme> <http://data.total.com/resource/ontology/ctg/Document-type> .\n";
                                }
                        ...
                        if (item.ChapterId) {
                            ...
                            if (!chaptersMap[key]) {
                                ...
                                var topChapterUrl =
                                    "<http://data.total.com/resource/ontology/ctg/Chapter/" +
                                    getNewId() +
                                    ">";
                            ...
                            resourceStr +=
                                paragraphUrl +
                                " <http://www.w3.org/2004/02/skos/core#inScheme> <http://data.total.com/resource/ontology/ctg/Paragraph> .\n";
                            resourceStr +=
                                paragraphUrl +
                                " <http://www.w3.org/2004/02/skos/core#broader> " +
                                chaptersMap[key] +
                            ...
                            resourceStr +=
                                chaptersMap[key] +
                                ' <http://www.w3.org/2004/02/skos/core#prefLabel> "' +
                                formatString(item.ChapterLabel.trim()) +
                                '" .\n';
                            resourceStr +=
                                chaptersMap[key] +
                                " <http://www.w3.org/2004/02/skos/core#inScheme> <http://data.total.com/resource/ontology/ctg/Chapter> .\n";
                            resourceStr +=
                                chaptersMap[key] +
                                " <http://www.w3.org/2004/02/skos/core#broader> " +
                                docsMap[item.Document] +
                        ...
                        if (entitiesUriStr && entitiesUriStr.split) {
                            entitiesUriStr.split(";").forEach(function (itemEntity, indexX) {
                                ...
                                if (!label)
                                    return console.log(
                                        "ERROR " + paragraphUrl + " :  " + splitArray.toString()
                                    );
                                ...
                                if (uniqueEntities.indexOf(entityId) < 0) {
                                    ...
                                    if (!topConceptsMap[type]) {
                                        ...
                                        topConceptsStr +=
                                            "<http://data.total.com/resource/ontology/ctg/EntityType/" +
                                            type +
                                            "> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> skos:ConceptScheme.\n";
                                        topConceptsStr +=
                                            "<http://data.total.com/resource/ontology/ctg/EntityType/" +
                                            type +
                                            '> <http://www.w3.org/2004/02/skos/core#prefLabel> "' +
                                    ...
                                    strEntities +=
                                        "<" +
                                        entityId +
                                        "> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://data.total.com/resource/ontology/ctg/EntityType/" +
                                        type +
                                        "> .\n";
                                }
                                ...
                                if (quantumMap[entityId]) {
                                    ...
                                    strEntities +=
                                        ...
                                        formatString(quantumMap[entityId].Definition) +
                                        '"@en .\n';
                                }
                            });
                        }
                        ...
                        if (entitiesUriStr && entitiesUriStr.split) {
                            entitiesUriStr.split(";").forEach(function (itemEntity, indexX) {
                                ...
                                str +=
                                    paragraphUrl +
                                    " <http://data.total.com/resource/ontology/ctg/properties#" +
                                    type +
                                    ">" +
                                    "<" +
                                    value +
                        ...
                        if (relationsStr0 && relationsStr0 != "[]") {
                            var relationTypeUri =
                                "http://data.total.com/resource/ontology/ctg/relation#";
                            var relationUri =
                                "http://data.total.com/resource/ontology/ctg/Relation/" +
                                relationsCounter++;
